...
function getSteps() {
  return ['Awaiting Parcel', 'Received Parcel', 'Shipped', 'Arrived at warehouse', 'Dispatched']
}

function getStepContent(step) {
  switch (step) {
    case 0:
      return `We're waiting for your parcel to be delivered at our international warehouse.`;
    case 1:
